...
const user_image = `<img src="${url_prefix}/assets/img/user1-48x48.png" alt="User Avatar">`;
const gpt_image = `<img src="${url_prefix}/assets/img/user2-48x48.png" alt="GPT Avatar">`;
